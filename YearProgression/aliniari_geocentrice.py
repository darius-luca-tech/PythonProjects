...
class Planete:
	...
	def main():
		...
		verificare(aliniari)
	def Neptun_planeta():
		print("Neptun:" + str(float(Planete.alinieri_geocentrice('Neptun', d))))

	def Soare_stea():
		print("Soare:" + str(float(Planete.alinieri_geocentrice('Soare', Planete.main.d))))

	def Uranus_planeta():
		print("Uranus:" + str(float(Planete.alinieri_geocentrice('Uranus', Planete.main.d))))

	def Saturn_planeta():
		print("Saturn:" + str(float(Planete.alinieri_geocentrice('Saturn', Planete.main.d))))

	def Jupiter_planeta():
		print("Jupiter:" + str(float(Planete.alinieri_geocentrice('Jupiter', Planete.main.d))))

	def Marte_planeta():
		print("Marte:" + str(float(Planete.alinieri_geocentrice('Marte', Planete.main.d))))

	def Venus_planea():
		print("Venus:" + str(float(Planete.alinieri_geocentrice('Venus', Planete.main.d))))

	def Mercur_planeta():
		print("Mercur:" + str(float(Planete.alinieri_geocentrice('Mercur', Planete.main.d))))

	def Luna_satelit():
		print("Luna:" + str(float(Planete.alinieri_geocentrice('Luna', Planete.main.d)) - 7))
