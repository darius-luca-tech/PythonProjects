...
def draw_next_shape(shape, surface): 
	...
	label = font.render('Uramtoarea forma', 1, (255, 255, 255)) 
...
def main():  
	...
	draw_text_middle("AI PIERDUT", 40, (255, 255, 255), win) 
	pygame.display.update() 
...
def main_menu(): 
	...
	while run:  
		win.fill((0, 0, 0)) 
		draw_text_middle("APASATI ORICE TASTA PENTRU A INCEPE", 40, (255, 255, 255), win) 
		pygame.display.update() 
		for event in pygame.event.get(): 
			if event.type == pygame.QUIT: 
				run = False 
